...
//ENVIA EMAIL INVITACION A REGISTRO
function invitacion_registro($email, $link ,$usuario){
    ...
    try {
        ...
        // Content
        $mail->isHTML(true);                                  // Set email format to HTML
        $mail->Subject = 'Crear contraseña';
        $mail->Body    = 'Se ha dado del alta al usuario '.$usuario.' en el Mixatrón de Binary Sunset. <br> Clica en este: <a href="' . $link . '">LINK</a> para crear tu contraseña';
        //$mail->AltBody = 'Thi  body in plain text for non-HTML mail clients';
        $mail->CharSet = 'UTF-8';
        $mail->send();
        //echo 'Message has been sent';
